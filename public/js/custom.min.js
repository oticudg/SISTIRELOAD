...
var twotable = $('#new-records-table').DataTable({
    ...
    buttons : [
    {
        ...
        className: 'btn-xs bg-purple btn-flat',
        ...
        },
        {
            ...
            extend: 'excel', title: 'EXCEL DE HISTORIAS', text: '<span class="fa fa-file-excel-o"></span> EXPORTAR EXCEL' 
        },
        {
            exportOptions: {
                columns: [ 0, 1, 2, 3, 4, 5 ]
            }, 
            extend: 'pdf', title: 'PDF DE HISTORIAS', text: '<span class="fa fa-file-pdf-o"></span> EXPORTAR PDF' 
        },
        { 
        ...
        complete: function () {
            $(".show-index, .edit-index, .destroy-index").click(function (e) {
                ...
                if (destroy !== -1) {
                    ...
                    swal({
                        title: 'ESTA USTED SEGURO DE ELIMINAR LA HISTORIA?',
                ...
                .done(function (res) {
                    if (show !== -1) {
                        ...
                        $("#records td#address").text(res.address);
                        $("#records td#observation").text(res.observation);
                        $("#records td#user").text(res.user.name + ' ' + res.user.last_name);
                        $("#records td#updateu_id").text(res.updated_at + ' ' + res.updateu_id);
                        if (res.parish) {
                        ...
                        $("#modalform #address").val(res.address);
...
function restoreMsgHis() {
    let msg = {
        number_record: 'INGRESAR POR LO MENOS ENTRE 1-11 DÍGITOS.',
        type_doc: 'DOCUMENTO',
        patient_id: 'INGRESAR ENTRE 4-8 DÍGITOS.',
        name: 'INGRESAR NOMBRES.',
        last_name: 'INGRESAR APELLIDOS.',
        sex: 'INGRESAR SEXO.',
        birthdate: 'INGRESAR FECHA DE NACIMIENTO.',
        admission_date: 'INGRESAR FECHA DE INGRESO.',
        egress_date: 'INGRESAR FECHA DE EGRESO.',
        state: 'INGRESAR EL ESTADO DE DONDE PROVIENE.',
        municipality: 'INGRESAR EL MUNICIPIO DE DONDE PROVIENE.',
        parish: 'INGRESAR LA PARROQUIA DE DONDE PROVIENE.',
        foreigncountry: 'INGRESAR EL PAÍS DE DONDE PROVIENE.',
        triage_id: 'INGRESAR EL TRIAJE DE ENTRADA.',
    }
    let $form = $('#modalform');
        ...
        if (!e.isDefaultPrevented()){
            ...
            $.ajax({
                ...
                error : function(data){
                    swal({
                        title: 'Oops...',
                        text: 'Oops... Los datos no cumplieron el requerimiento.',
                        type: 'error',
                        timer: '3000'
                    })
                }
