...
<div class="box box-info">
    <div class="box-header with-border text-center">
        <h3 class="box-title">Historias registradas</h3>
    </div>
                 ...
                 <div class="row">
                     <div class="form-group col-md-3">
                            <div class="input-group date" data-provide="datepicker">
                                ...
                                <input type="text" id="birthdate" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" name="birthdate" readonly class="form-control input-sm" placeholder="dd/mm/aaaa">
                            </div>
                        ...
                        <div class="form-group col-md-3">
                            <div class="input-group date" data-provide="datepicker">
                                ...
                                <input type="text" class="form-control input-sm" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" id="admission_date" name="admission_date" placeholder="dd/mm/aaaa" readonly>
                            </div>
