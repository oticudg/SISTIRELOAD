        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ url('triagechart') }}"><i class="fa fa-hospital-o text-primary"></i> Triaje de entrada</a></li>
                    <li><a href="{{ url('docchart') }}"><i class="fa fa-wheelchair text-danger"></i> Tipo de paciente</a></li>
                </ul>
            </li>
            @if(Auth::user()->admin())
